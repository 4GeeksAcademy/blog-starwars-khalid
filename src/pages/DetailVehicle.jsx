...
const DetailVehicle = () => {
  ...
  const imageUrl = `https://raw.githubusercontent.com/dsmora/star-wars-guide/refs/heads/master/build/assets/img/vehicles/${id}.jpg`;
  const favorite = isFavorite(id, "vehicle");
    ...
    <div style={{ background: "#0a0a0f", minHeight: "100vh", padding: "40px 30px", color: "white" }}>
      ...
      <div style={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
        <div style={{ position: "relative" }}>
          ...
          />
          <button
            onClick={() => toggleFavorite({ uid: id, name: vehicle.name, type: "vehicle" })}
            style={{
              position: "absolute",
              top: "12px",
              right: "12px",
        ...
        <div style={{ flex: 1, minWidth: "280px" }}>
          <h1 style={{ color: "#FFE81F", fontSize: "2.5rem", marginBottom: "8px" }}>{vehicle.name}</h1>
